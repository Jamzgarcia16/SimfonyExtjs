...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'examen', 'host' => '127.0.0.1', 'port' => '5432', 'user' => 'postgres', 'password' => 123456, 'charset' => 'UTF8', 'driver' => 'pdo_pgsql', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '71908ca21909eb3c1ff8f4aaefbe1b1672196d79');
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/xampp/htdocs/symfony2/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/xampp/htdocs/symfony2/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\xampp\\htdocs\\symfony2\\src\\sf2\\jamzBundle/Resources/views', 'sf2jamz');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('71908ca21909eb3c1ff8f4aaefbe1b1672196d79');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'sf2jamzBundle' => 'sf2\\jamzBundle\\sf2jamzBundle',
            ),
            ...
            'mailer_user' => 'postgres',
            'mailer_password' => 123456,
            'locale' => 'en',
            'secret' => '71908ca21909eb3c1ff8f4aaefbe1b1672196d79',
            'database_path' => NULL,
            ...
            'kernel.secret' => '71908ca21909eb3c1ff8f4aaefbe1b1672196d79',
            ...
            'swiftmailer.transport.smtp.username' => 'postgres',
            'swiftmailer.transport.smtp.password' => 123456,
