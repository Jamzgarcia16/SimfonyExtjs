...
Ext.define('Ext.calendar.view.AbstractCalendar', {
    ...
    onClick: function(e, t) {
        ...
        console.log("aqui va");
        console.log(t);
        console.log(this.eventSelector);
        ...
        if (el) {
            ...
            console.log(id);
            console.log("////");
            console.log(this.getEventRecord(id));
            var eventRec = horarioGrupoStore.findRecord('EventId',id);
            this.fireEvent('eventclick', this, eventRec, el);
